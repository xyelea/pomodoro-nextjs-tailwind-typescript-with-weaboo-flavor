...
function ModalSetting({
  ...
  const inputs = [
    { value: "pomodoro", ref: pomodoroRef, defaultValue: 25 },
  ...
  return (
    <>
      <div
        ...
        onClick={() => setOpenSetting(false)}></div>
      <div
        ...
        <div className="text-blue-400 flex justify-between items-center">
          <h1 className="uppercase font-bold tracking-wider">Atur Waktu</h1>
          <FiX
        ...
        <button
          className="bg-blue-700 uppercase w-full mt-5 text-white rounded py-2"
